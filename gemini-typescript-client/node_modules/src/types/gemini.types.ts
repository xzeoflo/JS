...
type modelName = "gemini-2.5-flash-lite";
...
function isSuccessResponse(response: ApiResponse): response is SuccessResponse {
    return response.success === "true" || response.success === "True" || response.success === "TRUE";
}

export { MessageRole, TemperatureLevel, Message, msgHystory, generationConfig, responseMetadata, RequestOptions, SuccessResponse, ErrorResponse, ApiResponse, Statistics, isSuccessResponse };
