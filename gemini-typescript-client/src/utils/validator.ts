...
import { apiKey, modelName, timestamp, debug, metadata, rawResponse, MessageRole, TemperatureLevel, Message, msgHistory, generationConfig, responseMetadata, RequestOptions, SuccessResponse, ErrorResponse, ApiResponse, Statistics, isSuccessResponse  } from '../types/gemini.types';
...
// Exportez les fonctions créées
export { validateApiKey, formatPrompt, createDefaultConfig, calculateElapsedTime, logMessages };
...
// Votre code ici
function isStatKey(key: string): key is keyof Statistics {
...
// Utilise keyof
// Votre code ici
type ConfigKeys = keyof generationConfig;
...
// Votre code ici
function updateStat<K extends keyof Statistics>(stats: Statistics, key: K, value: Statistics[K]): Statistics {
